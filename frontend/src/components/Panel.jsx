...
import { askJarvis, translateSelection } from "../utils/api";
import { getPageState, savePageState } from "../utils/storage";
    ...
    <div className="jarvis-panel" role="dialog" aria-label="Jarvis assistant">
      ...
      {transcript && (
        <div className="jarvis-panel__transcript">
          <Mic size={14} className="text-slate-400 shrink-0" /> "{transcript}"
        </div>
      )}
      ...
      {/* ── Error banner ── */}
      {error && (
        <div className="jarvis-panel__error flex items-start gap-2">
